  ...
  describe("Basic premium unlocking", function () {
    ...
    it("Should  Unlock Front page frequency data", async function () {
      ...
      try {
        ...
        var progressBar = await table.findElement(
          By.className("inner-progressbar")
        );
      } catch {
        assert.fail();
      }
    ...
    it("Should Unlock Front page Company Button", async function () {
      ...
      let companyName = await swipper[1]
    ...
    it("Should Unlock Company tag button", async function () {
      ...
      try {
        var lockLogo = await driver
          .findElement(By.className("pt-3"))
    ...
    it("Should unlock premium Problem", async function () {
      await driver.get(
        "https://leetcode.com/problemset/database/?premium=true&page=1"
      );
      await driver.sleep(5000);
      try {
        var modifiedElement = await driver.findElement(
          By.css("div[is-premium='true']")
        );
      } catch (e) {
