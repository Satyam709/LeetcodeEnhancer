...
class CompaniesProblemUnlocker {
  ...
  onCompanyButtonClick = (event) => {
    ...
    this.analyticsManager.fireModifiedButtonClickedEvent(
      this.companyProblemButtonId,
      "CompanyButton",
      companyName
    );
    let title =
      event.currentTarget.getElementsByClassName("text-label-2")[0].textContent;
...
export { CompaniesProblemUnlocker };
